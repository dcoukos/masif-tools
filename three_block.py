...
model1 = ThreeConv(features=4, out=4, heads=p.heads).to(device)
model2 = ThreeConv(features=4, out=4, heads=p.heads).to(device)
model3 = ThreeConv(features=4, out=1, heads=p.heads).to(device)
