...
from models import GraphThreeConvBlock
...
models = [GraphThreeConvBlock(n_features=4, lin2=4, heads=p.heads).to(cpu),
          GraphThreeConvBlock(n_features=4, lin2=4, heads=p.heads).to(cpu),
          GraphThreeConvBlock(n_features=4, lin2=4, heads=p.heads).to(cpu),
          GraphThreeConvBlock(n_features=4, lin2=4, heads=p.heads).to(cpu),
          GraphThreeConvBlock(n_features=4, lin2=4, heads=p.heads).to(cpu)]
